    ...
    function submitInfo(){
        ...
        $.ajax( {
            ...
            success : function(result) {
                ...
                if(result.payload=="提交成功"){
                    alert("ur secret are fall in universum")
                    $("#info").val("")
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div style="width: 1005px;border-radius: 30px" class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="font"><textarea id="info" style="position: relative;top:100px;text-decoration: none;opacity: 0.3;border: soild snow" rows="5" cols="130"></textarea></div>
                <button type="button" onclick="submitInfo()" class="btn btn-light" style="position: absolute;bottom: 200px;left:430px;width: 150px;color:black;margin-bottom: 60px;font-weight: bold;background-color: white;opacity: 0.6">SUBMIT <i class="bi bi-heart-pulse-fill"></i></button>
            </div>
